...
test('asset layout helpers build deterministic Pokemon asset paths', () => {
  ...
  assert.match(buildPokeQuizzPreviewArchiveDirectory({ template_key: 'stat-clash' }), /Previews\/Stat Clash\/Older Generated Videos$/u);
  assert.match(buildPokeQuizzPreviewArchiveDirectory({ template_key: 'build-your-team' }), /Previews\/Build Your Team\/Older Generated Videos$/u);
});
