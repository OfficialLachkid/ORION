...
test('resolvePokeQuizzSelectionStatePath scopes runtime state by template', () => {
  ...
  assert.equal(
    resolvePokeQuizzSelectionStatePath({ template_id: 'pokemon.build-your-team.v1' }),
    'data/runtime/product-video-agent/poke-quizz/selection-state-build-your-team.json',
  );
  assert.equal(
