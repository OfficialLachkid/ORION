const SEREBII_POKEDEX_GENERATIONS = Object.freeze({
  ...
  8: {
    generation: 8,
    region: 'galar',
    sourceUrl: 'https://www.serebii.net/pokemon/gen8pokemon.shtml',
    typingBasis: 'current_canonical_types_from_serebii_gen8_page',
  },
  9: {
    generation: 9,
    region: 'paldea',
    sourceUrl: 'https://www.serebii.net/pokemon/gen9pokemon.shtml',
    typingBasis: 'current_canonical_types_from_serebii_gen9_page',
  },
});
...
export function parseSerebiiGen6Pokedex(html, options = {}) {
...
export function parseSerebiiGen8Pokedex(html, options = {}) {
  return parseSerebiiPokedex(html, { ...options, generation: 8 });
}

export function parseSerebiiGen9Pokedex(html, options = {}) {
  return parseSerebiiPokedex(html, { ...options, generation: 9 });
}
...
export async function fetchSerebiiGen6Pokedex(options = {}) {
...
export async function fetchSerebiiGen8Pokedex(options = {}) {
  return fetchSerebiiPokedex({ ...options, generation: 8 });
}

export async function fetchSerebiiGen9Pokedex(options = {}) {
  return fetchSerebiiPokedex({ ...options, generation: 9 });
}
...
export const DEFAULT_SEREBII_GEN8_SOURCE_URL = SEREBII_POKEDEX_GENERATIONS[8].sourceUrl;
export const DEFAULT_SEREBII_GEN9_SOURCE_URL = SEREBII_POKEDEX_GENERATIONS[9].sourceUrl;
